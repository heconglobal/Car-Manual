...
export default defineConfig({
 ...
 use:{baseURL:'http://127.0.0.1:5185',viewport:{width:1440,height:1000},reducedMotion:'reduce',navigationTimeout:90000,screenshot:'only-on-failure',trace:'retain-on-failure',
