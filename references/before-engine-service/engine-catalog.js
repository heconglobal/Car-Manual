...
for(const [id,section,name,desc,spread] of [
 ...
 ['pan','lubrication','Oil pan','Stepped stamped sump with a shallow timing-end shelf, drawn corners, open interior, flange and grouped drain plug. Shape follows GM H-19; local dimensions and finish are reconstructed.',[0,-.20,0]],
 ['pan-gasket','lubrication','Oil-pan gasket','Perimeter-seal layout for inspection. Separate 1985 end seals and the exact flange outline remain incomplete; this is not a fabrication template.',[0,-.07,0]],
...
engineParts.push(...ignitionParts,...engineControlParts);
