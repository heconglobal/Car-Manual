...
export function buildBody(h){
 ...
 const hoodPoint=(u,v)=>{const z=lerp(-1.786,-.61,v);const a=u*2-1;return [a*.659,lerp(.625,.818,v)+.013*(1-a*a)+.019*Math.sin(v*Math.PI)+.007*Math.exp(-(((Math.abs(a*.659)-.42)/.055)**2))*Math.sin(v*Math.PI),z];};
