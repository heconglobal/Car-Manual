...
export const waterPumpInternals=[
 ['hub','Pulley hub flange','Separate machined hub with four open bolt holes and a central shaft seat.',[-.12,0,0]],
 ['bearing','Unitized water-pump shaft and bearing','Separate shaft, outer bearing sleeve and end seals. The supplier-specific rolling elements remain unresolved.',[-.07,0,0]],
 ['seal','Water-pump mechanical seal assembly','Wet-side carrier, face and spring represented as one construction selection. Exact original seal stack remains unresolved.',[.08,0,0]],
 ['impeller','Water-pump impeller · reconstructed','Open centrifugal impeller with curved vanes. Six-vane count, diameter, material and profile are illustrative pending an original L44 pump reference.',[.14,0,0]],
].map(([key,name,description,spread])=>({id:`eng-water-pump-${key}`,section:'water-pump-detail',system:'engine',name,description,spread,location:'L44 water-pump construction view',aliases:`water pump coolant impeller seal bearing shaft pulley hub ${key}`,source:'GMB · general mechanical pump construction',sourceUrl:'https://gmb.net/blog/water-pump-components/',referenceNote:'Generic manufacturer construction reference only. GM 22P H-19 identifies the complete L44 pump; the GM service manual replaces that assembly. Internal dimensions, blade count, finishes, bearing and seal variants are reconstructed. This view is not a pump overhaul procedure or an original-equipment parts-ordering list.'}));
