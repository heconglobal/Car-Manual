...
export const chargingDatums={battery:[-.58,.650,.790],alternator:[-.365,.5036,1.36],starter:[-.060,.315,.920]};
...
function buildBattery(h){
 ...
 tube(id('positive-cable'),[pos,[-.66,.658,.94],[-.54,.50,.91],[-.40,.397,.87],[-.18,.39,.87],[-.146,.393,.934]],.006,'rubber');
