...
export function buildMechanics(h){
 ...
 cyl('ac-compressor',.069,.17,[.43,.38,.93],'metal',[0,0,Math.PI/2],.069,{option:'airConditioning',value:true});
 cyl('ac-compressor',.067,.034,[.53,.38,.93],'dark',[0,0,Math.PI/2],.067,{option:'airConditioning',value:true});
