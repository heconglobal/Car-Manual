...
5. **External completion:** engine lift brackets, exhaust heat shields and attachment hardware, breather tube/connector/grommet, fuel line clips/seals, full harness supports/grounds, confirmed factory plug-wire routes and cylinder mapping.
...
| Electrical / controls | Full loom and grounds, connectors, junction blocks, switches, fuses/relays and motors, with year-specific circuits. |
