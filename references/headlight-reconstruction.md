...
## September 23 electrical expansion

The catalog now has 189 selections, including 71 new electrical construction details. See [source mapping, terminal identities, implementation and limits](headlight-electrical-reconstruction.md). Three nested relay scopes and separate motor/connector/fusible-link parts replace the coarse relay boxes and grouped approximate motor pigtail. The service guide targets the actual C101 disconnect.
