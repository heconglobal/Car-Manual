...
- [1985 Pontiac 6E3, printed 90–91, figure 38](https://fieroinfo.com/manuals/1985_Fiero_6E3_Emissions_and_Drivability.pdf#page=92): electronic spark timing and external-coil wiring. The module has two pickup connections, two primary-coil connections and four ECM connections. No vacuum-advance canister is modeled. Primary coil harness and coil-to-cap high-voltage lead are distinct selectable parts.
...
## Initial ignition pass (historical counts)
...
Factory illustrations establish identities and relationships, not measured local dimensions. The model is **not yet a photorealistic, dimensionally verified full-parts replica**. The installed distributor variant, casting revisions, individual connector proportions, precise routes, plug-wire lengths, true gear teeth and engagement, all clip locations and the complete vehicle harness remain unverified. Pan and head profiles, pan fasteners and inferred finishes are likewise approximations; the model is not a gasket or machining template. The September 22 pass now gives plugs and wires the factory cylinder identities: trunk bank 1/3/5, cabin bank 2/4/6, counted passenger end to driver end. Firing order 1–2–3–4–5–6 is source checked. This does not verify distributor-cap clocking or the displayed high-tension lead routes. The distributor's local casting support and engine-bay fit remain approximate.
...
## September 22 circuit and datum follow-up

Four individually selectable EST conductors were added after the initial pass. The current ignition scope has 43 selections within the 320-selection engine explorer. Original figure 38 supports connector A / module G / circuit 453 / ECM B3, B / B / 424 / D5, C / R / 430 / B5 and D / E / 423 / B4. `scripts/audit-wiring.mjs` checks those assignments and the selectable conductor geometry. `scripts/audit-factory-datums.mjs` checks cylinder identity and shared bore placement. Exact wire lengths, cap clocking and full engine loom routing remain open.
