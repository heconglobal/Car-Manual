...
const coverage=[
 ...
 ['electrical.spec.js','tail-lamp-review.spec.js'],
 ['electrical.spec.js'],
 ['electrical.spec.js'],
 ['ignition.spec.js'],
 ['engine.spec.js','engine-service.spec.js','valve-gear.spec.js','oil-pump.spec.js'],
 ...
 ['fuel.spec.js'],
 ['exhaust.spec.js'],
 ['transmission-cooling.spec.js','engine-service.spec.js','coolant-guide.spec.js'],
 ['hvac.spec.js'],
 ['body-hardware.spec.js','exterior.spec.js','configuration.spec.js'],
 ['exterior.spec.js'],
 ['body-hardware.spec.js','rear-body.spec.js','exterior.spec.js','sunroof.spec.js','configuration.spec.js','body-shape-review.spec.js','tail-lamp-review.spec.js'],
