...
export const options = [
 ...
 {key:'lampGroup',label:'Lamp group',type:'toggle',note:'Adds separate footwell, front-compartment and rear luggage-compartment lamps with factory-listed bulb types. Full circuit routing and option contents still need verification.'}
];
