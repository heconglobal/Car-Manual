...
// Chevrolet Power, 60° V6 chapter, printed 3-2 / figure 11 on 3-5.
// Production-family dimensions; this is not a Fiero installed-position drawing.
export const chevroletV6Blueprint='https://fieroinfo.com/manuals/Chevrolet_60V6_Power_Manual.pdf#page=6';
export const v6BlockNominal={deckHeight:.224,bankStagger:.044,camHeight:.15903};
